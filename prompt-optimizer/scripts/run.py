#!/usr/bin/env python3
"""
Universal runner for Prompt Optimizer skill scripts
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nAvailable scripts:")
        print("  optimizer.py        - Main CLI for prompt optimization")
        print("  gemini_client.py    - Test Gemini API connection")
        sys.exit(1)
